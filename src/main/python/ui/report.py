...
class Ui_saveReportDialog(object):
    def setupUi(self, saveReportDialog):
        ...
        self.gridLayout.addLayout(self.horizontalLayout_5, 24, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.buttonBox, 25, 0, 1, 3)
        ...
        self.gridLayout.addWidget(self.limitsButton, 21, 2, 1, 1)
        ...
        self.label_9 = QtWidgets.QLabel(saveReportDialog)
    ...
    def retranslateUi(self, saveReportDialog):
        ...
        self.label_9.setText(_translate("saveReportDialog", "URL"))
