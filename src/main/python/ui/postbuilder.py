...
class Ui_postbuilder(object):
    def setupUi(self, postbuilder):
        ...
        self.titleField.editingFinished.connect(postbuilder.build_avs_post)
        self.yearField.editingFinished.connect(postbuilder.build_avs_post)
        self.editionField.editingFinished.connect(postbuilder.build_avs_post)
        self.seasonField.editingFinished.connect(postbuilder.build_avs_post)
        self.noteField.editingFinished.connect(postbuilder.build_avs_post)
        self.warningField.editingFinished.connect(postbuilder.build_avs_post)
        self.pvaField.editingFinished.connect(postbuilder.build_avs_post)
        self.sourcePicker.currentIndexChanged['QString'].connect(postbuilder.build_avs_post)
        self.spectrumField.editingFinished.connect(postbuilder.build_avs_post)
