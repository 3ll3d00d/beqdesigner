...
class Ui_postbuilder(object):
    def setupUi(self, postbuilder):
        ...
        self.buttonGrid.addWidget(self.tmdbButton, 0, 0, 1, 1)
        ...
        self.tmdbGrid.addWidget(self.authorLabel, 0, 5, 1, 1)
        self.ratingField = QtWidgets.QLineEdit(postbuilder)
        self.ratingField.setObjectName("ratingField")
        self.tmdbGrid.addWidget(self.ratingField, 0, 4, 1, 1)
        ...
        postbuilder.setTabOrder(self.fileName, self.tmdbButton)
        postbuilder.setTabOrder(self.tmdbButton, self.generateButton)
