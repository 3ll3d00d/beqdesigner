...
class Ui_postbuilder(object):
    def setupUi(self, postbuilder):
        ...
        self.postTypePicker.currentIndexChanged['int'].connect(postbuilder.post_type_changed)
        self.languagePicker.currentIndexChanged['QString'].connect(postbuilder.build_avs_post)
        self.tmdbButton.clicked.connect(postbuilder.load_tmdb_info)
        self.avsURLField.textChanged['QString'].connect(postbuilder.build_avs_post)
        self.titleField.editingFinished.connect(postbuilder.autofillSortTitle)
