...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.octaveSmoothing = QtWidgets.QComboBox(parent=self.centralwidget)
        ...
        self.limitsButton = QtWidgets.QToolButton(parent=self.centralwidget)
        self.limitsButton.setObjectName("limitsButton")
        self.leftPane.addWidget(self.limitsButton, 0, 8, 1, 1)
        self.showValuesButton = QtWidgets.QToolButton(parent=self.centralwidget)
        self.showValuesButton.setObjectName("showValuesButton")
        self.leftPane.addWidget(self.showValuesButton, 0, 7, 1, 1)
        self.chartSplitter = QtWidgets.QSplitter(parent=self.centralwidget)
        self.chartSplitter.setLineWidth(1)
        self.chartSplitter.setOrientation(QtCore.Qt.Orientation.Vertical)
        self.chartSplitter.setObjectName("chartSplitter")
        self.mainChartContainer = QtWidgets.QFrame(parent=self.chartSplitter)
        ...
        self.mainChartLeftTools = QtWidgets.QFrame(parent=self.mainChartContainer)
        ...
        self.y1AutoOnButton = QtWidgets.QToolButton(parent=self.mainChartLeftTools)
        ...
        self.y1AutoOffButton = QtWidgets.QToolButton(parent=self.mainChartLeftTools)
        ...
        self.y1MinPlus10Button = QtWidgets.QToolButton(parent=self.mainChartLeftTools)
        ...
        self.y1MinPlus5Button = QtWidgets.QToolButton(parent=self.mainChartLeftTools)
        self.y1MinPlus5Button.setObjectName("y1MinPlus5Button")
        self.mainChartLeftToolBottomLayout.addWidget(self.y1MinPlus5Button)
        self.y1MinMinus5Button = QtWidgets.QToolButton(parent=self.mainChartLeftTools)
        ...
        self.y1MinMinus10Button = QtWidgets.QToolButton(parent=self.mainChartLeftTools)
        ...
        self.mainChart = MplWidget(parent=self.mainChartContainer)
        self.mainChart.setObjectName("mainChart")
        self.mainChartLayout.addWidget(self.mainChart)
        self.mainChartRightTools = QtWidgets.QFrame(parent=self.mainChartContainer)
        ...
        self.y2AutoOnButton = QtWidgets.QToolButton(parent=self.mainChartRightTools)
        ...
        self.y2AutoOffButton = QtWidgets.QToolButton(parent=self.mainChartRightTools)
        ...
        self.y2MinPlus10Button = QtWidgets.QToolButton(parent=self.mainChartRightTools)
        ...
        self.y2MinPlus5Button = QtWidgets.QToolButton(parent=self.mainChartRightTools)
        self.y2MinPlus5Button.setObjectName("y2MinPlus5Button")
        self.mainChartRightToolBottomLayout.addWidget(self.y2MinPlus5Button)
        self.y2MinMinus5Button = QtWidgets.QToolButton(parent=self.mainChartRightTools)
        ...
        self.y2MinMinus10Button = QtWidgets.QToolButton(parent=self.mainChartRightTools)
        ...
        self.waveformScrollArea = QtWidgets.QScrollArea(parent=self.chartSplitter)
        self.waveformScrollArea.setWidgetResizable(True)
        self.waveformScrollArea.setObjectName("waveformScrollArea")
        self.waveformScrollAreaWidgetContents = QtWidgets.QWidget()
        self.waveformScrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 1137, 576))
        self.waveformScrollAreaWidgetContents.setObjectName("waveformScrollAreaWidgetContents")
        self.waveformScrollAreaWidgetLayouy = QtWidgets.QHBoxLayout(self.waveformScrollAreaWidgetContents)
        self.waveformScrollAreaWidgetLayouy.setObjectName("waveformScrollAreaWidgetLayouy")
        self.waveformContainer = QtWidgets.QFrame(parent=self.waveformScrollAreaWidgetContents)
        ...
        self.waveformIsFiltered = QtWidgets.QCheckBox(parent=self.waveformContainer)
        self.waveformIsFiltered.setObjectName("waveformIsFiltered")
        self.checkboxContainer.addWidget(self.waveformIsFiltered)
        self.hardClipWaveform = QtWidgets.QCheckBox(parent=self.waveformContainer)
        self.hardClipWaveform.setObjectName("hardClipWaveform")
        self.checkboxContainer.addWidget(self.hardClipWaveform)
        self.saveWaveformChartButton = QtWidgets.QToolButton(parent=self.waveformContainer)
        ...
        self.signalSelectorLabel = QtWidgets.QLabel(parent=self.waveformContainer)
        ...
        self.headroom = QtWidgets.QDoubleSpinBox(parent=self.waveformContainer)
        ...
        self.sourceFile = QtWidgets.QLineEdit(parent=self.waveformContainer)
        self.sourceFile.setReadOnly(True)
        self.sourceFile.setObjectName("sourceFile")
        self.sourceFileLayout.addWidget(self.sourceFile)
        self.loadSignalButton = QtWidgets.QToolButton(parent=self.waveformContainer)
        ...
        self.sourceFileLabel = QtWidgets.QLabel(parent=self.waveformContainer)
        self.sourceFileLabel.setObjectName("sourceFileLabel")
        self.waveformControls.addWidget(self.sourceFileLabel, 2, 0, 1, 1)
        self.startTime = QtWidgets.QTimeEdit(parent=self.waveformContainer)
        ...
        self.rmsLevel = QtWidgets.QDoubleSpinBox(parent=self.waveformContainer)
        ...
        self.crestFactor = QtWidgets.QDoubleSpinBox(parent=self.waveformContainer)
        ...
        self.analysisLabel = QtWidgets.QLabel(parent=self.waveformContainer)
        self.analysisLabel.setObjectName("analysisLabel")
        self.waveformControls.addWidget(self.analysisLabel, 5, 0, 1, 1)
        self.bmHeaderLabel = QtWidgets.QLabel(parent=self.waveformContainer)
        font = QtGui.QFont()
        font.setBold(True)
        self.bmHeaderLabel.setFont(font)
        self.bmHeaderLabel.setFrameShape(QtWidgets.QFrame.Shape.Box)
        self.bmHeaderLabel.setFrameShadow(QtWidgets.QFrame.Shadow.Sunken)
        self.bmHeaderLabel.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.bmHeaderLabel.setObjectName("bmHeaderLabel")
        self.waveformControls.addWidget(self.bmHeaderLabel, 9, 0, 1, 2)
        self.signalSelector = QtWidgets.QComboBox(parent=self.waveformContainer)
        ...
        self.yMin = QtWidgets.QDoubleSpinBox(parent=self.waveformContainer)
        ...
        self.yMax = QtWidgets.QDoubleSpinBox(parent=self.waveformContainer)
        ...
        self.label_2 = QtWidgets.QLabel(parent=self.waveformContainer)
        font = QtGui.QFont()
        font.setBold(True)
        ...
        self.zoomInButton = QtWidgets.QToolButton(parent=self.waveformContainer)
        self.zoomInButton.setObjectName("zoomInButton")
        self.horizontalLayout.addWidget(self.zoomInButton)
        self.zoomOutButton = QtWidgets.QToolButton(parent=self.waveformContainer)
        self.zoomOutButton.setObjectName("zoomOutButton")
        self.horizontalLayout.addWidget(self.zoomOutButton)
        self.showStatsButton = QtWidgets.QToolButton(parent=self.waveformContainer)
        ...
        self.bmClippingLabel = QtWidgets.QLabel(parent=self.waveformContainer)
        self.bmClippingLabel.setObjectName("bmClippingLabel")
        self.waveformControls.addWidget(self.bmClippingLabel, 11, 0, 1, 1)
        self.yRangeLabel = QtWidgets.QLabel(parent=self.waveformContainer)
        ...
        self.headroomLabel = QtWidgets.QLabel(parent=self.waveformContainer)
        self.headroomLabel.setObjectName("headroomLabel")
        self.waveformControls.addWidget(self.headroomLabel, 4, 0, 1, 1)
        self.bmHeadroom = QtWidgets.QComboBox(parent=self.waveformContainer)
        ...
        self.endTimeLabel = QtWidgets.QLabel(parent=self.waveformContainer)
        ...
        self.bmlpfPosition = QtWidgets.QComboBox(parent=self.waveformContainer)
        self.bmlpfPosition.setObjectName("bmlpfPosition")
        self.bmLayout.addWidget(self.bmlpfPosition)
        self.bmhpfOn = QtWidgets.QCheckBox(parent=self.waveformContainer)
        ...
        self.startTimeLabel = QtWidgets.QLabel(parent=self.waveformContainer)
        self.startTimeLabel.setObjectName("startTimeLabel")
        self.waveformControls.addWidget(self.startTimeLabel, 6, 0, 1, 1)
        self.bmlpfPositionLabel = QtWidgets.QLabel(parent=self.waveformContainer)
        ...
        self.bmClipBefore = QtWidgets.QCheckBox(parent=self.waveformContainer)
        self.bmClipBefore.setObjectName("bmClipBefore")
        self.bmClippingOptions.addWidget(self.bmClipBefore)
        self.bmClipAfter = QtWidgets.QCheckBox(parent=self.waveformContainer)
        ...
        self.bmHeadroomLabel = QtWidgets.QLabel(parent=self.waveformContainer)
        self.bmHeadroomLabel.setObjectName("bmHeadroomLabel")
        self.waveformControls.addWidget(self.bmHeadroomLabel, 12, 0, 1, 1)
        self.label_3 = QtWidgets.QLabel(parent=self.waveformContainer)
        font = QtGui.QFont()
        font.setBold(True)
        ...
        self.waveformChart = PlotWidgetWithDateAxis(parent=self.waveformContainer)
        self.waveformChart.setObjectName("waveformChart")
        self.waveformLayout.addWidget(self.waveformChart)
        self.filteredSpectrumChart = MplWidget(parent=self.waveformContainer)
        ...
        self.waveformScrollAreaWidgetLayouy.addWidget(self.waveformContainer)
        self.waveformScrollArea.setWidget(self.waveformScrollAreaWidgetContents)
        self.leftPane.addWidget(self.chartSplitter, 1, 0, 1, 10)
        self.filterReference = QtWidgets.QComboBox(parent=self.centralwidget)
        ...
        self.signalReference = QtWidgets.QComboBox(parent=self.centralwidget)
        ...
        self.smoothAllSignals = QtWidgets.QCheckBox(parent=self.centralwidget)
        self.smoothAllSignals.setObjectName("smoothAllSignals")
        self.leftPane.addWidget(self.smoothAllSignals, 0, 5, 1, 1)
        self.referenceLabel = QtWidgets.QLabel(parent=self.centralwidget)
        self.referenceLabel.setObjectName("referenceLabel")
        self.leftPane.addWidget(self.referenceLabel, 0, 0, 1, 1)
        self.signalVisibilityButton = QtWidgets.QToolButton(parent=self.centralwidget)
        ...
        self.signalsLabel = QtWidgets.QLabel(parent=self.centralwidget)
        font = QtGui.QFont()
        font.setBold(True)
        self.signalsLabel.setFont(font)
        self.signalsLabel.setFrameShape(QtWidgets.QFrame.Shape.Box)
        self.signalsLabel.setFrameShadow(QtWidgets.QFrame.Shadow.Sunken)
        self.signalsLabel.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        ...
        self.addSignalButton = QtWidgets.QToolButton(parent=self.centralwidget)
        ...
        self.linkSignalButton = QtWidgets.QToolButton(parent=self.centralwidget)
        ...
        self.deleteSignalButton = QtWidgets.QToolButton(parent=self.centralwidget)
        ...
        self.clearSignalsButton = QtWidgets.QToolButton(parent=self.centralwidget)
        ...
        self.signalView = QtWidgets.QTableView(parent=self.centralwidget)
        self.signalView.setObjectName("signalView")
        self.rightPane.addWidget(self.signalView)
        self.filtersLabel = QtWidgets.QLabel(parent=self.centralwidget)
        font = QtGui.QFont()
        font.setBold(True)
        self.filtersLabel.setFont(font)
        self.filtersLabel.setFrameShape(QtWidgets.QFrame.Shape.Box)
        self.filtersLabel.setFrameShadow(QtWidgets.QFrame.Shadow.Sunken)
        ...
        self.filterPresetToolbarLayout = QtWidgets.QHBoxLayout()
        self.filterPresetToolbarLayout.setObjectName("filterPresetToolbarLayout")
        self.filterPresetCombo = QtWidgets.QComboBox(parent=self.centralwidget)
        self.filterPresetCombo.setObjectName("filterPresetCombo")
        self.filterPresetToolbarLayout.addWidget(self.filterPresetCombo)
        self.addFilterPresetButton = QtWidgets.QToolButton(parent=self.centralwidget)
        self.addFilterPresetButton.setToolTip("")
        self.addFilterPresetButton.setObjectName("addFilterPresetButton")
        self.filterPresetToolbarLayout.addWidget(self.addFilterPresetButton)
        self.duplicateFilterPresetButton = QtWidgets.QToolButton(parent=self.centralwidget)
        self.duplicateFilterPresetButton.setToolTip("")
        self.duplicateFilterPresetButton.setObjectName("duplicateFilterPresetButton")
        self.filterPresetToolbarLayout.addWidget(self.duplicateFilterPresetButton)
        self.renameFilterPresetButton = QtWidgets.QToolButton(parent=self.centralwidget)
        self.renameFilterPresetButton.setToolTip("")
        self.renameFilterPresetButton.setObjectName("renameFilterPresetButton")
        self.filterPresetToolbarLayout.addWidget(self.renameFilterPresetButton)
        self.deleteFilterPresetButton = QtWidgets.QToolButton(parent=self.centralwidget)
        self.deleteFilterPresetButton.setToolTip("")
        self.deleteFilterPresetButton.setObjectName("deleteFilterPresetButton")
        self.filterPresetToolbarLayout.addWidget(self.deleteFilterPresetButton)
        self.rightPane.addLayout(self.filterPresetToolbarLayout)
        self.filterToolbarLayout = QtWidgets.QHBoxLayout()
        self.filterToolbarLayout.setObjectName("filterToolbarLayout")
        self.preset1Button = QtWidgets.QToolButton(parent=self.centralwidget)
        ...
        self.preset2Button = QtWidgets.QToolButton(parent=self.centralwidget)
        ...
        self.preset3Button = QtWidgets.QToolButton(parent=self.centralwidget)
        ...
        self.addFilterButton = QtWidgets.QToolButton(parent=self.centralwidget)
        ...
        self.editFilterButton = QtWidgets.QToolButton(parent=self.centralwidget)
        ...
        self.deleteFilterButton = QtWidgets.QToolButton(parent=self.centralwidget)
        ...
        self.clearFiltersButton = QtWidgets.QToolButton(parent=self.centralwidget)
        ...
        self.filterView = QtWidgets.QTableView(parent=self.centralwidget)
        ...
        self.widgetGridLayout.addLayout(self.panes, 0, 1, 1, 1)
        ...
        self.menuPresets = QtWidgets.QMenu(parent=self.menuFile)
        self.menuPresets.setObjectName("menuPresets")
        self.menuLoad = QtWidgets.QMenu(parent=self.menuPresets)
        self.menuLoad.setObjectName("menuLoad")
        self.menu_Clear = QtWidgets.QMenu(parent=self.menuPresets)
        self.menu_Clear.setObjectName("menu_Clear")
        self.menu_Store = QtWidgets.QMenu(parent=self.menuPresets)
        ...
        self.actionExtract_Audio = QtGui.QAction(parent=MainWindow)
        self.actionExtract_Audio.setObjectName("actionExtract_Audio")
        self.actionPresets = QtGui.QAction(parent=MainWindow)
        self.actionPresets.setObjectName("actionPresets")
        self.actionClear_Preset_3 = QtGui.QAction(parent=MainWindow)
        self.actionClear_Preset_3.setObjectName("actionClear_Preset_3")
        self.actionSave_Chart = QtGui.QAction(parent=MainWindow)
        self.actionSave_Chart.setObjectName("actionSave_Chart")
        self.actionExport_Biquad = QtGui.QAction(parent=MainWindow)
        self.actionExport_Biquad.setObjectName("actionExport_Biquad")
        self.actionSave_Filter = QtGui.QAction(parent=MainWindow)
        self.actionSave_Filter.setEnabled(False)
        self.actionSave_Filter.setObjectName("actionSave_Filter")
        self.actionLoad_Filter = QtGui.QAction(parent=MainWindow)
        ...
        self.action_load_preset_1 = QtGui.QAction(parent=MainWindow)
        self.action_load_preset_1.setObjectName("action_load_preset_1")
        self.action_load_preset_2 = QtGui.QAction(parent=MainWindow)
        self.action_load_preset_2.setObjectName("action_load_preset_2")
        self.action_load_preset_3 = QtGui.QAction(parent=MainWindow)
        self.action_load_preset_3.setObjectName("action_load_preset_3")
        self.action_clear_preset_1 = QtGui.QAction(parent=MainWindow)
        self.action_clear_preset_1.setObjectName("action_clear_preset_1")
        self.action_clear_preset_2 = QtGui.QAction(parent=MainWindow)
        self.action_clear_preset_2.setObjectName("action_clear_preset_2")
        self.action_clear_preset_3 = QtGui.QAction(parent=MainWindow)
        self.action_clear_preset_3.setObjectName("action_clear_preset_3")
        self.action_store_preset_1 = QtGui.QAction(parent=MainWindow)
        self.action_store_preset_1.setObjectName("action_store_preset_1")
        self.action_store_preset_2 = QtGui.QAction(parent=MainWindow)
        self.action_store_preset_2.setObjectName("action_store_preset_2")
        self.action_store_preset_3 = QtGui.QAction(parent=MainWindow)
        self.action_store_preset_3.setObjectName("action_store_preset_3")
        self.actionExport_FRD = QtGui.QAction(parent=MainWindow)
        ...
        self.action_Load_Project = QtGui.QAction(parent=MainWindow)
        self.action_Load_Project.setObjectName("action_Load_Project")
        self.actionSave_Signal = QtGui.QAction(parent=MainWindow)
        self.actionSave_Signal.setObjectName("actionSave_Signal")
        self.actionLoad_Signal = QtGui.QAction(parent=MainWindow)
        self.actionLoad_Signal.setObjectName("actionLoad_Signal")
        self.actionClear_Project = QtGui.QAction(parent=MainWindow)
        self.actionClear_Project.setObjectName("actionClear_Project")
        self.actionAnalyse_Audio = QtGui.QAction(parent=MainWindow)
        ...
        self.action_Designers = QtGui.QAction(parent=MainWindow)
        self.action_Designers.setObjectName("action_Designers")
        self.action_Batch_Design = QtGui.QAction(parent=MainWindow)
        self.action_Batch_Design.setObjectName("action_Batch_Design")
        ...
        self.action_Remux_Audio = QtGui.QAction(parent=MainWindow)
        self.action_Remux_Audio.setObjectName("action_Remux_Audio")
        self.actionAdd_BEQ_Filter = QtGui.QAction(parent=MainWindow)
        self.actionAdd_BEQ_Filter.setObjectName("actionAdd_BEQ_Filter")
        self.actionClear_Signals = QtGui.QAction(parent=MainWindow)
        self.actionClear_Signals.setObjectName("actionClear_Signals")
        self.action1_1_Smoothing = QtGui.QAction(parent=MainWindow)
        self.action1_1_Smoothing.setObjectName("action1_1_Smoothing")
        self.action1_3_Smoothing = QtGui.QAction(parent=MainWindow)
        self.action1_3_Smoothing.setObjectName("action1_3_Smoothing")
        self.action1_6_Smoothing = QtGui.QAction(parent=MainWindow)
        self.action1_6_Smoothing.setObjectName("action1_6_Smoothing")
        self.action1_1_2_Smoothing = QtGui.QAction(parent=MainWindow)
        self.action1_1_2_Smoothing.setObjectName("action1_1_2_Smoothing")
        self.action1_2_4_Smoothing = QtGui.QAction(parent=MainWindow)
        self.action1_2_4_Smoothing.setObjectName("action1_2_4_Smoothing")
        self.action1_4_8_Smoothing = QtGui.QAction(parent=MainWindow)
        self.action1_4_8_Smoothing.setObjectName("action1_4_8_Smoothing")
        self.action_Remove_Smoothing = QtGui.QAction(parent=MainWindow)
        self.action_Remove_Smoothing.setObjectName("action_Remove_Smoothing")
        self.actionClear_Filters = QtGui.QAction(parent=MainWindow)
        self.actionClear_Filters.setObjectName("actionClear_Filters")
        self.actionMerge_Minidsp_XML = QtGui.QAction(parent=MainWindow)
        ...
        self.actionExport_BEQ_Filter = QtGui.QAction(parent=MainWindow)
        self.actionExport_BEQ_Filter.setObjectName("actionExport_BEQ_Filter")
        self.actionCreate_AVS_Post = QtGui.QAction(parent=MainWindow)
        self.actionCreate_AVS_Post.setObjectName("actionCreate_AVS_Post")
        self.actionSync_with_HTP_1 = QtGui.QAction(parent=MainWindow)
        self.actionSync_with_HTP_1.setObjectName("actionSync_with_HTP_1")
        self.actionBrowse_Catalogue = QtGui.QAction(parent=MainWindow)
        self.actionBrowse_Catalogue.setObjectName("actionBrowse_Catalogue")
        self.actionManage_JRiver_MC = QtGui.QAction(parent=MainWindow)
        self.actionManage_JRiver_MC.setObjectName("actionManage_JRiver_MC")
        self.actionShow_Filter_Widget = QtGui.QAction(parent=MainWindow)
        self.actionShow_Filter_Widget.setObjectName("actionShow_Filter_Widget")
        self.actionMerge_Signals = QtGui.QAction(parent=MainWindow)
        ...
        self.menu_Tools.addSeparator()
        self.menu_Tools.addAction(self.action_Batch_Design)
        self.menu_Tools.addAction(self.action_Review_Batch_Designs)
        self.menu_Tools.addAction(self.action_Designers)
        self.menu_Tools.addSeparator()
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.addFilterPresetButton.setText(_translate("MainWindow", "New"))
        self.duplicateFilterPresetButton.setText(_translate("MainWindow", "Duplicate"))
        self.renameFilterPresetButton.setText(_translate("MainWindow", "Rename"))
        self.deleteFilterPresetButton.setText(_translate("MainWindow", "Delete"))
        self.preset1Button.setText(_translate("MainWindow", "C1"))
        self.preset1Button.setShortcut(_translate("MainWindow", "Ctrl+Shift+1"))
        self.preset2Button.setText(_translate("MainWindow", "C2"))
        self.preset2Button.setShortcut(_translate("MainWindow", "Ctrl+Shift+2"))
        self.preset3Button.setText(_translate("MainWindow", "C3"))
        ...
        self.menuPresets.setTitle(_translate("MainWindow", "&Clipboard"))
        ...
        self.actionClear_Preset_3.setText(_translate("MainWindow", "Clear Clipboard 3"))
        ...
        self.action_Designers.setText(_translate("MainWindow", "&Designers"))
        self.action_Batch_Design.setText(_translate("MainWindow", "Batch &Design"))
