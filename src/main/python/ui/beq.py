...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.waveformControls.addItem(spacerItem, 6, 0, 1, 2)
        ...
        self.waveformControls.addLayout(self.horizontalLayout, 5, 0, 1, 2)
        ...
        self.resetWaveformLimitsButton.clicked.connect(MainWindow.resetWaveformLimits)
        self.applyWaveformLimitsButton.clicked.connect(MainWindow.applyWaveformLimits)
        self.waveformIsFiltered.stateChanged['int'].connect(MainWindow.applyWaveformFilter)
        self.signalSelector.currentIndexChanged['QString'].connect(MainWindow.showWaveform)
        self.startTime.timeChanged['QTime'].connect(MainWindow.setWaveformStartTime)
        self.endTime.timeChanged['QTime'].connect(MainWindow.setWaveformEndTime)
        self.zoomInButton.clicked.connect(MainWindow.zoomInWaveform)
        self.zoomOutButton.clicked.connect(MainWindow.zoomOutWaveform)
