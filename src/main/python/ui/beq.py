...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.waveformControls.addItem(spacerItem, 12, 0, 1, 2)
        ...
        self.menuView.addAction(self.action1_1_Smoothing)
        self.menuView.addAction(self.action1_3_Smoothing)
        self.menuView.addAction(self.action1_6_Smoothing)
        self.menuView.addAction(self.action1_1_2_Smoothing)
        self.menuView.addAction(self.action1_2_4_Smoothing)
        self.menuView.addAction(self.action_Remove_Smoothing)
