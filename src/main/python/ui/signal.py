...
class Ui_addSignalDialog(object):
    def setupUi(self, addSignalDialog):
        ...
        self.wavGridLayout.addWidget(self.previewButton, 9, 0, 1, 3)
        spacerItem1 = QtWidgets.QSpacerItem(20, 40, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.wavGridLayout.addItem(spacerItem1, 8, 1, 1, 1)
        ...
        self.wavGridLayout.addWidget(self.loadAllChannels, 7, 0, 1, 3)
