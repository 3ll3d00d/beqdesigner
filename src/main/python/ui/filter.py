...
class Ui_editFilterDialog(object):
    def setupUi(self, editFilterDialog):
        ...
        self.paramsPane.addWidget(self.sStepButton, 5, 2, 1, 1)
        ...
        self.showCombined = QtWidgets.QCheckBox(editFilterDialog)
        self.showCombined.setChecked(True)
        self.showCombined.setObjectName("showCombined")
        self.paramsPane.addWidget(self.showCombined, 8, 0, 1, 3)
        ...
        self.addMoreButton = QtWidgets.QToolButton(editFilterDialog)
        self.addMoreButton.setText("")
        self.addMoreButton.setObjectName("addMoreButton")
        self.horizontalLayout.addWidget(self.addMoreButton)
        self.exitButton = QtWidgets.QToolButton(editFilterDialog)
        self.exitButton.setObjectName("exitButton")
        self.horizontalLayout.addWidget(self.exitButton)
        self.paramsPane.addLayout(self.horizontalLayout, 9, 0, 1, 3)
        ...
        self.showCombined.clicked.connect(editFilterDialog.previewFilter)
        self.addButton.clicked.connect(editFilterDialog.save)
        self.addMoreButton.clicked.connect(editFilterDialog.accept)
    ...
    def retranslateUi(self, editFilterDialog):
        ...
        self.showCombined.setText(_translate("editFilterDialog", "Show Complete Filter?"))
        self.addButton.setToolTip(_translate("editFilterDialog", "Add"))
        self.addButton.setText(_translate("editFilterDialog", "..."))
        self.addMoreButton.setToolTip(_translate("editFilterDialog", "Save and Exit"))
