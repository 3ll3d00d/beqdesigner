...
class Ui_editFilterDialog(object):
    def setupUi(self, editFilterDialog):
        ...
        self.paramsPane.addLayout(self.snapLayout, 12, 0, 1, 3)
        ...
        self.paramsPane.addLayout(self.buttonLayout, 10, 0, 1, 3)
        ...
        self.paramsPane.addLayout(self.optimiseLayout, 13, 0, 1, 3)
        ...
        self.paramsPane.addItem(spacerItem, 11, 1, 1, 1)
        ...
        self.paramsPane.addWidget(self.snapshotFilterView, 14, 0, 1, 3)
