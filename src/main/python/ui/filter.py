...
class Ui_editFilterDialog(object):
    def setupUi(self, editFilterDialog):
        ...
        self.paramsPane.addWidget(self.showCombined, 9, 0, 1, 3)
        ...
        self.paramsPane.addItem(spacerItem, 14, 1, 1, 1)
        ...
        self.paramsPane.addLayout(self.horizontalLayout, 11, 0, 1, 3)
        ...
        self.paramsPane.addWidget(self.showIndividual, 10, 0, 1, 3)
