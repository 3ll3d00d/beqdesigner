...
class Ui_editFilterDialog(object):
    def setupUi(self, editFilterDialog):
        ...
        self.previewChart = MplWidget(parent=editFilterDialog)
        ...
        self.filterCountLabel = QtWidgets.QLabel(parent=editFilterDialog)
        self.filterCountLabel.setObjectName("filterCountLabel")
        self.paramsPane.addWidget(self.filterCountLabel, 10, 0, 1, 1)
        self.filterType = QtWidgets.QComboBox(parent=editFilterDialog)
        ...
        self.gainLabel = QtWidgets.QLabel(parent=editFilterDialog)
        self.gainLabel.setObjectName("gainLabel")
        self.paramsPane.addWidget(self.gainLabel, 9, 0, 1, 1)
        self.ltInLabel = QtWidgets.QLabel(parent=editFilterDialog)
        self.ltInLabel.setObjectName("ltInLabel")
        self.paramsPane.addWidget(self.ltInLabel, 11, 0, 1, 1)
        self.headerLabel = QtWidgets.QLabel(parent=editFilterDialog)
        font = QtGui.QFont()
        font.setBold(True)
        self.headerLabel.setFont(font)
        self.headerLabel.setFrameShape(QtWidgets.QFrame.Shape.Box)
        self.headerLabel.setFrameShadow(QtWidgets.QFrame.Shadow.Sunken)
        ...
        self.snapshotFilterView = QtWidgets.QTableView(parent=editFilterDialog)
        self.snapshotFilterView.setEditTriggers(QtWidgets.QAbstractItemView.EditTrigger.NoEditTriggers)
        self.snapshotFilterView.setSelectionMode(QtWidgets.QAbstractItemView.SelectionMode.SingleSelection)
        self.snapshotFilterView.setSelectionBehavior(QtWidgets.QAbstractItemView.SelectionBehavior.SelectRows)
        self.snapshotFilterView.setObjectName("snapshotFilterView")
        self.paramsPane.addWidget(self.snapshotFilterView, 18, 0, 1, 2)
        self.freqLabel = QtWidgets.QLabel(parent=editFilterDialog)
        ...
        self.fp = NoFillDoubleSpinBox(parent=editFilterDialog)
        ...
        self.qp = NoFillDoubleSpinBox(parent=editFilterDialog)
        ...
        self.typeLabel = QtWidgets.QLabel(parent=editFilterDialog)
        self.typeLabel.setObjectName("typeLabel")
        self.paramsPane.addWidget(self.typeLabel, 3, 0, 1, 1)
        self.filterQ = NoFillDoubleSpinBox(parent=editFilterDialog)
        self.filterQ.setCorrectionMode(QtWidgets.QAbstractSpinBox.CorrectionMode.CorrectToNearestValue)
        ...
        self.workingViewButtonWidget = QtWidgets.QWidget(parent=editFilterDialog)
        ...
        self.addWorkingRowButton = QtWidgets.QToolButton(parent=self.workingViewButtonWidget)
        ...
        self.removeWorkingRowButton = QtWidgets.QToolButton(parent=self.workingViewButtonWidget)
        ...
        self.pasteWorkingRowButton = QtWidgets.QToolButton(parent=self.workingViewButtonWidget)
        ...
        self.importWorkingButton = QtWidgets.QToolButton(parent=self.workingViewButtonWidget)
        ...
        self.orderLabel = QtWidgets.QLabel(parent=editFilterDialog)
        self.orderLabel.setObjectName("orderLabel")
        self.paramsPane.addWidget(self.orderLabel, 5, 0, 1, 1)
        self.filterS = NoFillDoubleSpinBox(parent=editFilterDialog)
        ...
        self.snapshotViewButtonWidget = QtWidgets.QWidget(parent=editFilterDialog)
        ...
        self.addSnapshotRowButton = QtWidgets.QToolButton(parent=self.snapshotViewButtonWidget)
        ...
        self.removeSnapshotRowButton = QtWidgets.QToolButton(parent=self.snapshotViewButtonWidget)
        ...
        self.pasteSnapshotRowButton = QtWidgets.QToolButton(parent=self.snapshotViewButtonWidget)
        ...
        self.importSnapshotButton = QtWidgets.QToolButton(parent=self.snapshotViewButtonWidget)
        ...
        self.sStepButton = QtWidgets.QToolButton(parent=editFilterDialog)
        ...
        self.f0 = NoFillDoubleSpinBox(parent=editFilterDialog)
        ...
        self.q0 = NoFillDoubleSpinBox(parent=editFilterDialog)
        ...
        self.filterQLabel = QtWidgets.QLabel(parent=editFilterDialog)
        ...
        self.optimiseLabel = QtWidgets.QLabel(parent=editFilterDialog)
        font = QtGui.QFont()
        font.setBold(True)
        ...
        self.optimiseButton = QtWidgets.QToolButton(parent=editFilterDialog)
        self.optimiseButton.setObjectName("optimiseButton")
        self.optimiseLayout.addWidget(self.optimiseButton)
        self.targetBiquadCount = QtWidgets.QSpinBox(parent=editFilterDialog)
        ...
        self.filterCount = QtWidgets.QSpinBox(parent=editFilterDialog)
        ...
        self.filterOrder = QtWidgets.QSpinBox(parent=editFilterDialog)
        ...
        self.workingFilterView = QtWidgets.QTableView(parent=editFilterDialog)
        self.workingFilterView.setEditTriggers(QtWidgets.QAbstractItemView.EditTrigger.NoEditTriggers)
        self.workingFilterView.setSelectionMode(QtWidgets.QAbstractItemView.SelectionMode.SingleSelection)
        self.workingFilterView.setSelectionBehavior(QtWidgets.QAbstractItemView.SelectionBehavior.SelectRows)
        ...
        self.addWorkingPeakingButton = QtWidgets.QToolButton(parent=editFilterDialog)
        ...
        self.addWorkingLowShelfButton = QtWidgets.QToolButton(parent=editFilterDialog)
        ...
        self.addWorkingHighShelfButton = QtWidgets.QToolButton(parent=editFilterDialog)
        ...
        self.showIndividual = QtWidgets.QCheckBox(parent=editFilterDialog)
        ...
        self.showPhase = QtWidgets.QCheckBox(parent=editFilterDialog)
        ...
        self.filterType.currentTextChanged['QString'].connect(editFilterDialog.enableFilterParams) # type: ignore
        self.passFilterType.currentTextChanged['QString'].connect(editFilterDialog.changeOrderStep) # type: ignore
        self.filterQ.valueChanged['double'].connect(editFilterDialog.recalcShelfFromQ) # type: ignore
        self.filterGain.valueChanged['double'].connect(editFilterDialog.recalcShelfFromGain) # type: ignore
        self.filterType.currentIndexChanged['int'].connect(editFilterDialog.previewFilter) # type: ignore
        self.passFilterType.currentIndexChanged['int'].connect(editFilterDialog.previewFilter) # type: ignore
        self.filterOrder.valueChanged['int'].connect(editFilterDialog.previewFilter) # type: ignore
        self.freq.valueChanged['double'].connect(editFilterDialog.previewFilter) # type: ignore
        self.filterQ.valueChanged['double'].connect(editFilterDialog.previewFilter) # type: ignore
        self.filterGain.valueChanged['double'].connect(editFilterDialog.previewFilter) # type: ignore
        self.filterCount.valueChanged['int'].connect(editFilterDialog.previewFilter) # type: ignore
        self.filterS.valueChanged['double'].connect(editFilterDialog.recalcShelfFromS) # type: ignore
        self.sStepButton.clicked.connect(editFilterDialog.handleSToolButton) # type: ignore
        self.qStepButton.clicked.connect(editFilterDialog.handleQToolButton) # type: ignore
        self.gainStepButton.clicked.connect(editFilterDialog.handleGainToolButton) # type: ignore
        self.freqStepButton.clicked.connect(editFilterDialog.handleFreqToolButton) # type: ignore
        self.saveButton.clicked.connect(editFilterDialog.accept) # type: ignore
        self.exitButton.clicked.connect(editFilterDialog.reject) # type: ignore
        self.showIndividual.clicked.connect(editFilterDialog.previewFilter) # type: ignore
        self.limitsButton.clicked.connect(editFilterDialog.show_limits) # type: ignore
        self.fullRangeButton.clicked.connect(editFilterDialog.show_full_range) # type: ignore
        self.subOnlyButton.clicked.connect(editFilterDialog.show_sub_only) # type: ignore
        self.showPhase.clicked.connect(editFilterDialog.show_phase_response) # type: ignore
        self.f0.valueChanged['double'].connect(editFilterDialog.previewFilter) # type: ignore
        self.q0.valueChanged['double'].connect(editFilterDialog.previewFilter) # type: ignore
        self.fp.valueChanged['double'].connect(editFilterDialog.previewFilter) # type: ignore
        self.qp.valueChanged['double'].connect(editFilterDialog.previewFilter) # type: ignore
    ...
    def retranslateUi(self, editFilterDialog):
        ...
        self.filterType.setItemText(9, _translate("editFilterDialog", "All Pass"))
