...
class Ui_jriverDelayDialog(object):
    def setupUi(self, jriverDelayDialog):
        ...
        self.distance = QtWidgets.QDoubleSpinBox(parent=jriverDelayDialog)
        ...
        self.channelList = QtWidgets.QListWidget(parent=jriverDelayDialog)
        ...
        self.channelListLabel = QtWidgets.QLabel(parent=jriverDelayDialog)
        self.channelListLabel.setObjectName("channelListLabel")
        self.gridLayout.addWidget(self.channelListLabel, 2, 0, 1, 1)
        self.label = QtWidgets.QLabel(parent=jriverDelayDialog)
        self.label.setObjectName("label")
        self.gridLayout.addWidget(self.label, 0, 0, 1, 1)
        self.millis = QtWidgets.QDoubleSpinBox(parent=jriverDelayDialog)
        ...
        self.changeUnitButton = QtWidgets.QToolButton(parent=jriverDelayDialog)
        ...
        self.buttonBox = QtWidgets.QDialogButtonBox(parent=jriverDelayDialog)
