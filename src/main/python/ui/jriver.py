...
class Ui_jriverDspDialog(object):
    def setupUi(self, jriverDspDialog):
        ...
        self.splitter = QtWidgets.QSplitter(jriverDspDialog)
        self.splitter.setLineWidth(1)
        self.splitter.setOrientation(QtCore.Qt.Vertical)
        self.splitter.setObjectName("splitter")
        self.pipelineView = SvgView(self.splitter)
        self.pipelineView.setObjectName("pipelineView")
        self.previewChart = MplWidget(self.splitter)
        self.previewChart.setObjectName("previewChart")
        self.dialogLayout.addWidget(self.splitter, 1, 1, 1, 1)
        ...
        self.dialogLayout.addLayout(self.chartControlLayout, 2, 1, 1, 1)
