...
class Ui_jriverDspDialog(object):
    def setupUi(self, jriverDspDialog):
        ...
        self.uploadButton = QtWidgets.QToolButton(parent=jriverDspDialog)
        ...
        self.backButton = QtWidgets.QToolButton(parent=jriverDspDialog)
        self.backButton.setEnabled(False)
        self.backButton.setObjectName("backButton")
        self.configRow2Layout.addWidget(self.backButton)
        self.forwardButton = QtWidgets.QToolButton(parent=jriverDspDialog)
        self.forwardButton.setEnabled(False)
        self.forwardButton.setObjectName("forwardButton")
        self.configRow2Layout.addWidget(self.forwardButton)
        self.outputFormat = QtWidgets.QLineEdit(parent=jriverDspDialog)
        ...
        self.blockSelector = QtWidgets.QComboBox(parent=jriverDspDialog)
        ...
        self.moveTopButton = QtWidgets.QToolButton(parent=jriverDspDialog)
        ...
        self.moveUpButton = QtWidgets.QToolButton(parent=jriverDspDialog)
        ...
        self.moveDownButton = QtWidgets.QToolButton(parent=jriverDspDialog)
        ...
        self.moveBottomButton = QtWidgets.QToolButton(parent=jriverDspDialog)
        ...
        self.addFilterButton = QtWidgets.QToolButton(parent=jriverDspDialog)
        self.addFilterButton.setEnabled(False)
        self.addFilterButton.setPopupMode(QtWidgets.QToolButton.ToolButtonPopupMode.InstantPopup)
        self.addFilterButton.setObjectName("addFilterButton")
        self.filterButtonsLayout.addWidget(self.addFilterButton)
        self.editFilterButton = QtWidgets.QToolButton(parent=jriverDspDialog)
        ...
        self.deleteFilterButton = QtWidgets.QToolButton(parent=jriverDspDialog)
        ...
        self.clearFiltersButton = QtWidgets.QToolButton(parent=jriverDspDialog)
        ...
        self.splitFilterButton = QtWidgets.QToolButton(parent=jriverDspDialog)
        ...
        self.mergeFilterButton = QtWidgets.QToolButton(parent=jriverDspDialog)
        ...
        self.channelList = QtWidgets.QListWidget(parent=jriverDspDialog)
        ...
        self.filterList = QtWidgets.QListWidget(parent=jriverDspDialog)
        self.filterList.setProperty("showDropIndicator", False)
        self.filterList.setDragDropMode(QtWidgets.QAbstractItemView.DragDropMode.NoDragDrop)
        self.filterList.setDefaultDropAction(QtCore.Qt.DropAction.IgnoreAction)
        self.filterList.setSelectionMode(QtWidgets.QAbstractItemView.SelectionMode.ExtendedSelection)
        ...
        self.showDotButton = QtWidgets.QToolButton(parent=jriverDspDialog)
        ...
        self.direction = QtWidgets.QCheckBox(parent=jriverDspDialog)
        ...
        self.viewSplitter = QtWidgets.QSplitter(parent=jriverDspDialog)
        self.viewSplitter.setLineWidth(1)
        self.viewSplitter.setOrientation(QtCore.Qt.Orientation.Vertical)
        self.viewSplitter.setObjectName("viewSplitter")
        self.pipelineView = SvgView(parent=self.viewSplitter)
        self.pipelineView.setObjectName("pipelineView")
        self.chartWrapper = QtWidgets.QWidget(parent=self.viewSplitter)
        ...
        self.previewChart = MplWidget(parent=self.chartWrapper)
        ...
        self.buttonBox = QtWidgets.QDialogButtonBox(parent=jriverDspDialog)
