...
class Ui_jriverChannelSelectDialog(object):
    def setupUi(self, jriverChannelSelectDialog):
        ...
        jriverChannelSelectDialog.resize(337, 250)
        ...
        self.lfeChannelLabel = QtWidgets.QLabel(jriverChannelSelectDialog)
        self.lfeChannelLabel.setObjectName("lfeChannelLabel")
        self.gridLayout.addWidget(self.lfeChannelLabel, 0, 0, 1, 1)
        self.lfeChannel = QtWidgets.QComboBox(jriverChannelSelectDialog)
    ...
    def retranslateUi(self, jriverChannelSelectDialog):
        ...
        self.lfeChannelLabel.setText(_translate("jriverChannelSelectDialog", "LFE"))
