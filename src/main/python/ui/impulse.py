...
class Ui_impulseDialog(object):
    def setupUi(self, impulseDialog):
        ...
        self.buttonBox.accepted.connect(impulseDialog.accept)
        self.buttonBox.rejected.connect(impulseDialog.reject)
        self.limitsButton.clicked.connect(impulseDialog.show_limits)
        self.selectChannelsButton.toggled['bool'].connect(impulseDialog.update_chart)
        self.chartToggle.clicked.connect(impulseDialog.select_channels)
