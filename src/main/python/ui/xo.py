...
class Ui_xoDialog(object):
    def setupUi(self, xoDialog):
        ...
        self.xoContainerLayout.addWidget(self.peqScrollArea, 1, 0, 1, 4)
        ...
        self.setSWChannelsButton = QtWidgets.QPushButton(xoDialog)
        self.setSWChannelsButton.setObjectName("setSWChannelsButton")
        self.xoContainerLayout.addWidget(self.setSWChannelsButton, 0, 2, 1, 1)
        ...
        self.lfeAdjustLabel.setEnabled(False)
        ...
        self.lfeAdjust.setEnabled(False)
        ...
        self.xoContainerLayout.addLayout(self.lfeAdjustLayout, 0, 3, 1, 1)
        ...
        xoDialog.setTabOrder(self.showMatrixButton, self.setSWChannelsButton)
        xoDialog.setTabOrder(self.setSWChannelsButton, self.lfeAdjust)
    ...
    def retranslateUi(self, xoDialog):
        ...
        self.setSWChannelsButton.setText(_translate("xoDialog", "Set SW Channels"))
