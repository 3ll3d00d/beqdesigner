...
class Ui_xoDialog(object):
    def setupUi(self, xoDialog):
        ...
        self.previewChart = MplWidget(parent=xoDialog)
        ...
        self.lfeChannelSelectorLabel = QtWidgets.QLabel(parent=xoDialog)
        self.lfeChannelSelectorLabel.setObjectName("lfeChannelSelectorLabel")
        self.xoContainerLayout.addWidget(self.lfeChannelSelectorLabel, 0, 3, 1, 1)
        self.showMatrixButton = QtWidgets.QPushButton(parent=xoDialog)
        self.showMatrixButton.setObjectName("showMatrixButton")
        self.xoContainerLayout.addWidget(self.showMatrixButton, 0, 2, 1, 1)
        self.lfeAdjustLayout = QtWidgets.QHBoxLayout()
        self.lfeAdjustLayout.setObjectName("lfeAdjustLayout")
        self.lfeAdjustLabel = QtWidgets.QLabel(parent=xoDialog)
        ...
        self.lfeAdjust = QtWidgets.QSpinBox(parent=xoDialog)
        ...
        self.showFiltersButton = QtWidgets.QToolButton(parent=xoDialog)
        self.showFiltersButton.setObjectName("showFiltersButton")
        self.lfeAdjustLayout.addWidget(self.showFiltersButton)
        self.xoContainerLayout.addLayout(self.lfeAdjustLayout, 0, 5, 1, 1)
        self.linkChannelsButton = QtWidgets.QPushButton(parent=xoDialog)
        self.linkChannelsButton.setObjectName("linkChannelsButton")
        self.xoContainerLayout.addWidget(self.linkChannelsButton, 0, 0, 1, 1)
        self.peqScrollArea = QtWidgets.QScrollArea(parent=xoDialog)
        ...
        self.xoContainerLayout.addWidget(self.peqScrollArea, 1, 0, 1, 6)
        self.lfeChannelSelector = QtWidgets.QComboBox(parent=xoDialog)
        self.lfeChannelSelector.setObjectName("lfeChannelSelector")
        self.xoContainerLayout.addWidget(self.lfeChannelSelector, 0, 4, 1, 1)
        spacerItem1 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Minimum)
        self.xoContainerLayout.addItem(spacerItem1, 0, 1, 1, 1)
        self.verticalLayout.addLayout(self.xoContainerLayout)
        self.buttonBox = QtWidgets.QDialogButtonBox(parent=xoDialog)
    ...
    def retranslateUi(self, xoDialog):
        ...
        self.showTimingButton.setText(_translate("xoDialog", "..."))
