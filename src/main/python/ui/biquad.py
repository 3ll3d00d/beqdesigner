...
class Ui_exportBiquadDialog(object):
    def setupUi(self, exportBiquadDialog):
        ...
        self.biquads = QtWidgets.QPlainTextEdit(parent=exportBiquadDialog)
        font = QtGui.QFont()
        font.setFamily("Consolas")
        self.biquads.setFont(font)
        self.biquads.setReadOnly(True)
        self.biquads.setTextInteractionFlags(QtCore.Qt.TextInteractionFlag.TextSelectableByKeyboard|QtCore.Qt.TextInteractionFlag.TextSelectableByMouse)
        self.biquads.setObjectName("biquads")
        self.gridLayout.addWidget(self.biquads, 4, 0, 1, 3)
        self.horizontalLayout = QtWidgets.QHBoxLayout()
        self.horizontalLayout.setObjectName("horizontalLayout")
        self.setDefaults = QtWidgets.QToolButton(parent=exportBiquadDialog)
        self.setDefaults.setObjectName("setDefaults")
        self.horizontalLayout.addWidget(self.setDefaults)
        self.outputFormat = QtWidgets.QComboBox(parent=exportBiquadDialog)
        ...
        self.showHex.clicked.connect(exportBiquadDialog.updateBiquads) # type: ignore
        self.fs.currentIndexChanged['int'].connect(exportBiquadDialog.updateBiquads) # type: ignore
        self.maxBiquads.valueChanged['int'].connect(exportBiquadDialog.updateBiquads) # type: ignore
        self.setDefaults.clicked.connect(exportBiquadDialog.save) # type: ignore
        self.copyToClipboardBtn.clicked.connect(exportBiquadDialog.copyToClipboard) # type: ignore
        self.saveToFile.clicked.connect(exportBiquadDialog.export) # type: ignore
        self.outputFormat.currentTextChanged['QString'].connect(exportBiquadDialog.update_format) # type: ignore
    ...
    def retranslateUi(self, exportBiquadDialog):
        ...
        self.outputFormat.setItemText(4, _translate("exportBiquadDialog", "Equalizer APO"))
