...
class Ui_analysisDialog(object):
    def setupUi(self, analysisDialog):
        ...
        self.spectrumControlsLayout.addWidget(self.colourRangeLabel, 0, 3, 1, 1)
        ...
        self.spectrumControlsLayout.addItem(spacerItem1, 0, 5, 1, 1)
        self.dbRangeLabel = QtWidgets.QLabel(self.spectrumTab)
        self.dbRangeLabel.setObjectName("dbRangeLabel")
        self.spectrumControlsLayout.addWidget(self.dbRangeLabel, 0, 1, 1, 1)
        ...
        self.spectrumControlsLayout.addWidget(self.dbRange, 0, 2, 1, 1)
        ...
        self.spectrumControlsLayout.addWidget(self.colourRange, 0, 4, 1, 1)
    ...
    def retranslateUi(self, analysisDialog):
        ...
        self.clipAtAverage.setText(_translate("analysisDialog", "Clip at Average Level?"))
