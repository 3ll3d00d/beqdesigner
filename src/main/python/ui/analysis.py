...
class Ui_analysisDialog(object):
    def setupUi(self, analysisDialog):
        ...
        self.spectrumControlsLayout.addWidget(self.updateChart, 0, 7, 4, 1)
        ...
        self.spectrumControlsLayout.addWidget(self.freqRangeLabel, 0, 4, 1, 1)
        ...
        self.spectrumControlsLayout.addWidget(self.timeRangeLabe, 0, 3, 1, 1)
        ...
        self.spectrumControlsLayout.addWidget(self.minLabel, 1, 2, 1, 1)
        self.maxTime = QtWidgets.QTimeEdit(self.spectrumTab)
        self.maxTime.setObjectName("maxTime")
        self.spectrumControlsLayout.addWidget(self.maxTime, 2, 3, 1, 1)
        ...
        self.spectrumControlsLayout.addWidget(self.maxLabel, 2, 2, 1, 1)
        self.minFreq = QtWidgets.QSpinBox(self.spectrumTab)
        self.minFreq.setObjectName("minFreq")
        self.spectrumControlsLayout.addWidget(self.minFreq, 1, 4, 1, 1)
        ...
        self.spectrumControlsLayout.addWidget(self.colourRangeLabel, 0, 5, 1, 1)
        ...
        self.spectrumControlsLayout.addWidget(self.colourUpperLimit, 1, 5, 1, 1)
        ...
        self.spectrumControlsLayout.addWidget(self.colourLowerLimit, 2, 5, 1, 1)
        ...
        self.spectrumControlsLayout.addLayout(self.horizontalLayout, 2, 4, 1, 1)
        self.minTime = QtWidgets.QTimeEdit(self.spectrumTab)
        self.minTime.setObjectName("minTime")
        self.spectrumControlsLayout.addWidget(self.minTime, 1, 3, 1, 1)
        self.showSpectroButton = QtWidgets.QToolButton(self.spectrumTab)
        self.showSpectroButton.setObjectName("showSpectroButton")
        self.spectrumControlsLayout.addWidget(self.showSpectroButton, 0, 9, 1, 1)
        spacerItem1 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.spectrumControlsLayout.addItem(spacerItem1, 0, 8, 1, 1)
        ...
        self.spectrumControlsLayout.addWidget(self.magLowerLimit, 2, 6, 1, 1)
        ...
        self.spectrumControlsLayout.addWidget(self.magUpperLimit, 1, 6, 1, 1)
        self.filterTypeLabel = QtWidgets.QLabel(self.spectrumTab)
        self.filterTypeLabel.setObjectName("filterTypeLabel")
        self.spectrumControlsLayout.addWidget(self.filterTypeLabel, 0, 0, 1, 1)
        ...
        self.spectrumControlsLayout.addWidget(self.signalRangeLabel, 0, 6, 1, 1)
        ...
        self.spectrumControlsLayout.addWidget(self.markerSize, 2, 1, 1, 1)
        self.markerSizeLabel = QtWidgets.QLabel(self.spectrumTab)
        self.markerSizeLabel.setObjectName("markerSizeLabel")
        self.spectrumControlsLayout.addWidget(self.markerSizeLabel, 2, 0, 1, 1)
        self.markerTypeLabel = QtWidgets.QLabel(self.spectrumTab)
        self.markerTypeLabel.setObjectName("markerTypeLabel")
        self.spectrumControlsLayout.addWidget(self.markerTypeLabel, 1, 0, 1, 1)
        self.markerType = QtWidgets.QComboBox(self.spectrumTab)
        self.markerType.setObjectName("markerType")
        self.spectrumControlsLayout.addWidget(self.markerType, 1, 1, 1, 1)
        self.saveChartButton = QtWidgets.QToolButton(self.spectrumTab)
        self.saveChartButton.setObjectName("saveChartButton")
        self.spectrumControlsLayout.addWidget(self.saveChartButton, 1, 9, 1, 1)
        ...
        self.saveChartButton.clicked.connect(analysisDialog.save_chart)
    ...
    def retranslateUi(self, analysisDialog):
        ...
        self.filterTypeLabel.setText(_translate("analysisDialog", "Filter Type"))
        ...
        self.markerTypeLabel.setText(_translate("analysisDialog", "Marker Type"))
        self.saveChartButton.setText(_translate("analysisDialog", "..."))
