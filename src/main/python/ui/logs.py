...
class Ui_logsForm(object):
    def setupUi(self, logsForm):
        ...
        self.centralwidget = QtWidgets.QWidget(parent=logsForm)
        ...
        self.logViewer = QtWidgets.QPlainTextEdit(parent=self.centralwidget)
        font = QtGui.QFont()
        ...
        self.logLevel = QtWidgets.QComboBox(parent=self.centralwidget)
        ...
        self.logSizeLabel = QtWidgets.QLabel(parent=self.centralwidget)
        self.logSizeLabel.setObjectName("logSizeLabel")
        self.gridLayout.addWidget(self.logSizeLabel, 0, 0, 1, 1)
        self.maxRows = QtWidgets.QSpinBox(parent=self.centralwidget)
