...
class Ui_MergeSignalDialog(object):
    def setupUi(self, MergeSignalDialog):
        ...
        self.signals = QtWidgets.QListWidget(parent=MergeSignalDialog)
        self.signals.setDragEnabled(True)
        self.signals.setDragDropMode(QtWidgets.QAbstractItemView.DragDropMode.InternalMove)
        ...
        self.signalsLabel = QtWidgets.QLabel(parent=MergeSignalDialog)
        self.signalsLabel.setObjectName("signalsLabel")
        self.gridLayout.addWidget(self.signalsLabel, 0, 0, 1, 1)
        self.durationLabel = QtWidgets.QLabel(parent=MergeSignalDialog)
        self.durationLabel.setObjectName("durationLabel")
        self.gridLayout.addWidget(self.durationLabel, 1, 0, 1, 1)
        self.buttonBox = QtWidgets.QDialogButtonBox(parent=MergeSignalDialog)
        ...
        self.duration = QtWidgets.QTimeEdit(parent=MergeSignalDialog)
