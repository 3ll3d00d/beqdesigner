...
class Ui_graphLayoutDialog(object):
    def setupUi(self, graphLayoutDialog):
        ...
        self.y2Min = QtWidgets.QSpinBox(parent=graphLayoutDialog)
        ...
        self.y1Min = QtWidgets.QSpinBox(parent=graphLayoutDialog)
        ...
        self.xMax = QtWidgets.QSpinBox(parent=graphLayoutDialog)
        ...
        self.y1Max = QtWidgets.QSpinBox(parent=graphLayoutDialog)
        ...
        self.xMin = QtWidgets.QSpinBox(parent=graphLayoutDialog)
        ...
        self.applyButton = QtWidgets.QPushButton(parent=graphLayoutDialog)
        self.applyButton.setObjectName("applyButton")
        self.gridLayout.addWidget(self.applyButton, 1, 1, 1, 3)
        spacerItem = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Minimum)
        self.gridLayout.addItem(spacerItem, 2, 2, 1, 1)
        self.y2Max = QtWidgets.QSpinBox(parent=graphLayoutDialog)
        ...
        self.applyButton.clicked.connect(graphLayoutDialog.changeLimits) # type: ignore
        self.applyFullRangeX.clicked.connect(graphLayoutDialog.fullRangeLimits) # type: ignore
        self.applyBassX.clicked.connect(graphLayoutDialog.bassLimits) # type: ignore
