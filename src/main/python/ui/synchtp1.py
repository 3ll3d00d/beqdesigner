...
class Ui_syncHtp1Dialog(object):
    def setupUi(self, syncHtp1Dialog):
        ...
        syncHtp1Dialog.resize(1416, 549)
        ...
        self.removeBeqButton = QtWidgets.QPushButton(syncHtp1Dialog)
        self.removeBeqButton.setObjectName("removeBeqButton")
        self.gridLayout_2.addWidget(self.removeBeqButton, 0, 1, 1, 1)
        self.addBeqButton = QtWidgets.QPushButton(syncHtp1Dialog)
        self.addBeqButton.setObjectName("addBeqButton")
        self.gridLayout_2.addWidget(self.addBeqButton, 0, 0, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.showDetailsButton, 4, 2, 1, 1)
        ...
        self.addBeqButton.clicked.connect(syncHtp1Dialog.add_beq)
        self.removeBeqButton.clicked.connect(syncHtp1Dialog.remove_beq)
    ...
    def retranslateUi(self, syncHtp1Dialog):
        ...
        self.removeBeqButton.setText(_translate("syncHtp1Dialog", "Remove BEQ"))
        self.addBeqButton.setText(_translate("syncHtp1Dialog", "Add BEQ"))
