...
class Ui_geqDialog(object):
    def setupUi(self, geqDialog):
        ...
        self.limitsButton.clicked.connect(geqDialog.show_limits)
        self.peqCount.valueChanged['int'].connect(geqDialog.update_peq_editors)
        self.presetSelector.currentTextChanged['QString'].connect(geqDialog.update_peq_editors)
        self.advancedMode.toggled['bool'].connect(geqDialog.update_peq_editors)
        self.buttonBox.accepted.connect(geqDialog.accept)
        self.buttonBox.rejected.connect(geqDialog.reject)
