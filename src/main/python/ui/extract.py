...
class Ui_extractAudioDialog(object):
    def setupUi(self, extractAudioDialog):
        ...
        extractAudioDialog.resize(880, 850)
        ...
        self.gridLayout.addWidget(self.outputFilenameLabel, 6, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.targetDir, 5, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.ffmpegCommandLabel, 7, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.ffmpegOutputLabel, 8, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.ffmpegCommandLine, 7, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.outputFilename, 6, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.lfeChannelIndexLabel, 3, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.targetDirectoryLabel, 5, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.lfeChannelIndex, 3, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.monoMix, 4, 0, 1, 3)
        self.signalNameLabel = QtWidgets.QLabel(extractAudioDialog)
        self.signalNameLabel.setObjectName("signalNameLabel")
        self.gridLayout.addWidget(self.signalNameLabel, 10, 0, 1, 1)
        self.loadSignals = QtWidgets.QCheckBox(extractAudioDialog)
        self.loadSignals.setEnabled(True)
        self.loadSignals.setChecked(True)
        self.loadSignals.setObjectName("loadSignals")
        self.gridLayout.addWidget(self.loadSignals, 9, 0, 1, 3)
        ...
        self.gridLayout.addWidget(self.signalName, 10, 1, 1, 1)
    ...
    def retranslateUi(self, extractAudioDialog):
        ...
        self.loadSignals.setText(_translate("extractAudioDialog", "Create Signal(s)?"))
