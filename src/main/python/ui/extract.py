...
class Ui_extractAudioDialog(object):
    def setupUi(self, extractAudioDialog):
        ...
        self.horizontalLayout_2.addWidget(self.gainOffsetLabel)
        ...
        self.horizontalLayout_2.addWidget(self.gainOffset)
    ...
    def retranslateUi(self, extractAudioDialog):
        ...
        self.gainOffsetLabel.setText(_translate("extractAudioDialog", "Gain Adjustment"))
