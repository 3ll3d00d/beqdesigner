...
class Ui_extractAudioDialog(object):
    def setupUi(self, extractAudioDialog):
        ...
        self.gridLayout.addWidget(self.outputFilename, 8, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.signalName, 12, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.targetDirectoryLabel, 7, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.ffmpegOutput, 11, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.outputFilenameLabel, 8, 0, 1, 1)
        self.signalNameLabel = QtWidgets.QLabel(extractAudioDialog)
        self.signalNameLabel.setObjectName("signalNameLabel")
        self.gridLayout.addWidget(self.signalNameLabel, 12, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.ffmpegCommandLine, 9, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.ffmpegOutputLabel, 11, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.filterMapping, 6, 1, 1, 1)
