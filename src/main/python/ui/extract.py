...
class Ui_extractAudioDialog(object):
    def setupUi(self, extractAudioDialog):
        ...
        self.designEnabled = QtWidgets.QCheckBox(parent=extractAudioDialog)
        self.designEnabled.setObjectName("designEnabled")
        self.gridLayout.addWidget(self.designEnabled, 2, 0, 1, 1)
        self.designerCombo = QtWidgets.QComboBox(parent=extractAudioDialog)
        self.designerCombo.setEnabled(False)
        self.designerCombo.setObjectName("designerCombo")
        self.gridLayout.addWidget(self.designerCombo, 2, 1, 1, 1)
        self.queueDirLabel = QtWidgets.QLabel(parent=extractAudioDialog)
        self.queueDirLabel.setObjectName("queueDirLabel")
        self.gridLayout.addWidget(self.queueDirLabel, 4, 0, 1, 1)
        self.queueDirLayout = QtWidgets.QHBoxLayout()
        self.queueDirLayout.setObjectName("queueDirLayout")
        self.queueDirEdit = QtWidgets.QLineEdit(parent=extractAudioDialog)
        ...
        self.browseQueueDirButton = QtWidgets.QToolButton(parent=extractAudioDialog)
        ...
        self.gridLayout.addLayout(self.queueDirLayout, 4, 1, 1, 1)
    ...
    def retranslateUi(self, extractAudioDialog):
        ...
        self.designEnabled.setText(_translate("extractAudioDialog", "Design filters?"))
        self.queueDirLabel.setText(_translate("extractAudioDialog", "Queue Directory"))
        self.browseQueueDirButton.setText(_translate("extractAudioDialog", "..."))
