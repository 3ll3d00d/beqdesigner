...
class Ui_mergeDspDialog(object):
    def setupUi(self, mergeDspDialog):
        ...
        self.buttonBox.accepted.connect(mergeDspDialog.accept)
        self.buttonBox.rejected.connect(mergeDspDialog.reject)
        self.configFilePicker.clicked.connect(mergeDspDialog.pick_config_file)
        self.outputDirectoryPicker.clicked.connect(mergeDspDialog.pick_output_dir)
        self.processFiles.clicked.connect(mergeDspDialog.process_files)
        self.refreshGitRepo.clicked.connect(mergeDspDialog.refresh_repo)
        self.userSourceDirPicker.clicked.connect(mergeDspDialog.pick_user_source_dir)
        self.clearUserSourceDir.clicked.connect(mergeDspDialog.clear_user_source_dir)
        self.beqRepos.currentTextChanged['QString'].connect(mergeDspDialog.update_beq_repo_status)
        self.copyOptimisedButton.clicked.connect(mergeDspDialog.copy_optimised)
        self.copyErrorsButton.clicked.connect(mergeDspDialog.copy_errors)
        self.dspType.currentTextChanged['QString'].connect(mergeDspDialog.dsp_type_changed)
        self.outputMode.currentTextChanged['QString'].connect(mergeDspDialog.output_mode_changed)
