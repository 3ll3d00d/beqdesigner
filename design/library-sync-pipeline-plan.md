...
| 28 | Workflow rework: documentation (§12.15) -- the user guide, `manage_mc.md` and `preferences.md`, new screenshots (T1). Detail in [`library-sync/workflow-rework/implementation-order.md`](library-sync/workflow-rework/implementation-order.md) (§12.13). | 27c | **Done (2026-09-21), not yet committed** -- `docs/library/` (9 pages), the updated `manage_mc.md`, `preferences.md`, `extract_audio.md`, `batch_extract.md`, the `mkdocs.yml` nav, 20 new or replaced screenshots; closes T1; **completes M5**. Docs only, so the suite is unchanged (1902 passed). |
