...
| 20 | Workflow rework: fixes to the current dialog that need no redesign (M0) -- review preloaded, entries named from the library, Enter scoped, failure details, unsaved-edit prompt, Reopen. | 19 | **Done -- commit `PENDING`** |
