...
(471 passed, 2026-09-19 review; 1377 after chunk 26a). Chunk 3 (real-server spike) is not done,
...
| §12.13 | [`library-sync/workflow-rework/implementation-order.md`](library-sync/workflow-rework/implementation-order.md) | chunks 19-28: order, dependencies, milestones, risks | chunks 19-25 and 26a built; 26b-28 not started |
