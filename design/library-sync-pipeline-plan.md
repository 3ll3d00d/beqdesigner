...
(471 passed, 2026-09-19 review; see the chunk 26b row for the current count). Chunk 3 (real-server spike) is not done,
...
| §12 (except §12.13) | [`library-sync/workflow-rework/design.md`](library-sync/workflow-rework/design.md) | the agreed workflow, discovery, state machine, revise, screen; **the frozen index schema (§12.5)** | discovery (chunk 24) and the stage entry points, selectors and bulk accept (chunk 25) built; the work list window (§12.10, chunk 26a, read-only) is built; its actions (26b), settings (26c) and the title page (27) are **design, not built** |
| §12.13 | [`library-sync/workflow-rework/implementation-order.md`](library-sync/workflow-rework/implementation-order.md) | chunks 19-28: order, dependencies, milestones, risks | chunks 19-25, 26a and 26b built (M3); 26c-28 not started |
...
| 26c-28 | Workflow rework (§12): work-list settings drawer (26c), title page (27a-c), documentation (28). Detail, dependencies, milestones and risks in [`library-sync/workflow-rework/implementation-order.md`](library-sync/workflow-rework/implementation-order.md) (§12.13); design in [`workflow-rework/design.md`](library-sync/workflow-rework/design.md). | 26a, 25 | **Not started** (design agreed 2026-09-19) |
